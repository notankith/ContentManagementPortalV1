  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
        ...
        {/* Inline branding visible inside the login card so it's shown without scrolling */}
        <div className="w-full max-w-md mx-auto mt-4 text-center text-sm text-gray-600">
          <a href="/ankith" target="_blank" rel="noopener noreferrer" className="underline text-gray-700 hover:text-gray-900">
